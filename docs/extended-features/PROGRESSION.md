...
| 7 | Help Center (reader + author, no AI) | `feature/phase7-help-center` | 🚧 | 2026-06-06 | — | Committed `92c482a` (not merged). Bilingual categories/articles, Purifier sanitize-on-save, MySQL FULLTEXT search (`scopeSearch`), `help_articles.read/manage` perms. Reader UI (`/help`, `/help/c/:slug`, `/help/a/:slug`) + author UI (Tiptap editor, list, form). 15 PHPUnit tests, Pint + Larastan clean, build green. Tiptap deps added (approved). Skipped AI (Phase 4) + auto-screenshots (Phase 5). Plan: `HELP_CENTER_PLAN.md`; testing: `testing/TASK_PHASE7_TESTING.md`. |
