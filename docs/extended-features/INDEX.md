...
| 6 — Global search (Typesense + Scout + search page) | [PHASE6_SEARCH_PLAN.md](PHASE6_SEARCH_PLAN.md) | 🔄 In progress | `feature/phase6-search` |
...
| Enhanced search page testing | Phase 6 (Part B) | *(to be created)* |
