...
| — | Phase 5 — Chat real-time, @mentions, typing, unread badge, attachments | `feature/phase5-chat` | 🔄 | 2026-06-04 | — | 4 broadcast events (ShouldBroadcastNow), team.{teamId} channel auth, ChatMentionNotification, NotificationService extended, TeamMessageResource, +5 controller methods, +7 routes, migration last_read_at, useTeamMessages.js rewrite (Echo + optimistic + whisper), Teams/Show.vue full chat UI overhaul, AppSidebar unread badge. 12 PHPUnit + 3 Dusk tests. Uncommitted. |
