                        ...
                        <div>
                            ...
                            <form @submit.prevent="handleSubmit">
                                <div class="space-y-5">
                                    ...
                                    >
                                        ...
                                        <div class="sm:col-span-1">
                                            ...
                                            <input
                                                ...
                                                :class="
                                                    validationErrors.first_name || validationErrors.name
                                    ...
                                    <div
                                        v-if="authError"
                                        class="rounded-lg bg-error-50 p-4 dark:bg-error-500/10"
                                    >
                                        <div class="flex items-center">
                                            <svg
                                                class="w-5 h-5 mr-2 text-error-500"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                            >
                                                <path
