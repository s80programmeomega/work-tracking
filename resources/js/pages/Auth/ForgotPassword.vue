        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              ...
              <!-- Success Message -->
              <div v-if="success" dusk="forgot-success" class="mb-5 rounded-3 bg-success-50 p-4 dark:bg-success-500/10">
              ...
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  ...
                  <div>
                    ...
                    <input v-model="email" type="email" id="email" name="email" dusk="forgot-email" placeholder="info@gmail.com"
                  ...
                  <!-- Button -->
                  <div>
                    <button type="submit" dusk="forgot-submit" :disabled="loading || success"
                      ...
                      {{ loading ? $t('auth.forgot_password_sending') : $t('auth.forgot_password_send') }}
                    </button>
                  </div>
                </div>
              </form>
              ...
              <div class="mt-5">
                <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                  ...
                  <router-link to="/signin" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">{{ $t('auth.signin') }}</router-link>
                </p>
              </div>
            </div>
          </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (err.response?.data?.errors) {
      ...
      error.value = err.response?.data?.message || t('auth.forgot_password_failed')
    }
  } finally {
    loading.value = false
  }
