      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div class="rounded-3 p-5 border border-blue-100 dark:border-blue-800/30">
          <div class="flex items-center">
            <div class="p-3 bg-blue-100 dark:bg-blue-800/40 rounded-3 mr-4">
        ...
        <div class="rounded-3 p-5 border border-green-100 dark:border-green-800/30">
          <div class="flex items-center">
            <div class="p-3 bg-green-100 dark:bg-green-800/40 rounded-3 mr-4">
        ...
        <div class="rounded-3 p-5 border border-purple-100 dark:border-purple-800/30">
          <div class="flex items-center">
            <div class="p-3 bg-purple-100 dark:bg-purple-800/40 rounded-3 mr-4">
        ...
        <div class="rounded-3 p-5 border border-orange-100 dark:border-orange-800/30">
          <div class="flex items-center">
            <div class="p-3 bg-orange-100 dark:bg-orange-800/40 rounded-3 mr-4">
      ...
      <div v-else-if="viewMode === 'grid'" ref="staggerRef" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="workspace in filteredWorkspaces" :key="workspace.id"
          ...
          <div class="absolute top-0 left-0 w-full h-2" 
            :class="workspace.is_active ? 'bg-brand-500' : 'bg-gray-400'"></div>

          <!-- Hover Effect -->
          <div class="absolute inset-0 transition-colors duration-200"></div>
            ...
            <div class="flex items-start space-x-4 mb-5">
              <div class="flex-shrink-0">
                <div v-if="workspace.logo_url" 
                  class="w-16 h-16 rounded-3 overflow-hidden border-2 border-white dark:border-gray-700 ">
                  <img :src="workspace.logo_url" :alt="workspace.nom" class="w-full h-full object-cover" />
                </div>
                <div v-else
                  class="w-16 h-16 rounded-3 flex items-center justify-center border-2 border-white dark:border-gray-700 transition-shadow">
          ...
          <div class="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
            <button @click.stop="openSettings(workspace)"
              class="w-8 h-8 rounded-md bg-white/80 dark:bg-gray-700/80 border border-gray-200 dark:border-gray-600 flex items-center justify-center hover:bg-white dark:hover:bg-gray-600 transition-colors ">
            ...
            <div class="flex-1 p-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4 flex-1 min-w-0">
                  ...
                  <div class="flex-shrink-0">
                    <div v-if="workspace.logo_url" 
                      class="w-12 h-12 rounded-3 overflow-hidden border border-gray-200 dark:border-gray-700">
                      <img :src="workspace.logo_url" :alt="workspace.nom" class="w-full h-full object-cover" />
                    </div>
                    <div v-else
