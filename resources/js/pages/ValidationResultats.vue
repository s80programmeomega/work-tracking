  ...
  <AdminLayout>
    <div class="min-h-screen bg-gray-50/50 dark:bg-gray-900/50">
        ...
        <div class="max-w-7xl mx-auto px-6 py-8">
          <div class="flex items-start justify-between">
            <div class="flex items-center gap-5">
              <div class="relative">
                <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center shadow-lg shadow-green-500/25">
          ...
          <div class="flex gap-1 mt-8 bg-gray-100/80 dark:bg-gray-800/80 rounded-2xl p-1.5 backdrop-blur-sm">
            ...
            >
              <div class="flex items-center gap-2.5">
                ...
                <span>{{ tab.label }}</span>
                <span v-if="tab.count > 0" class="px-2 py-1 text-xs font-bold bg-white/20 rounded-full min-w-[24px] text-center">
                  {{ tab.count }}
                </span>
              </div>
            </button>
      ...
      <div class="max-w-7xl mx-auto px-6 py-6">
        ...
        <!-- Error State -->
        <div v-else-if="error" class="rounded-2xl border border-red-200 bg-red-50/80 dark:bg-red-900/20 dark:border-red-800/50 p-8 backdrop-blur-sm">
        ...
        <div v-else class="space-y-6">
          ...
          <div v-if="currentResults.length === 0" 
            ...
            <p class="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
              Tous les résultats ont été traités pour le moment. Les nouvelles soumissions apparaîtront ici automatiquement.
            </p>
          </div>
          ...
          <div v-else class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <ResultatCard
              v-for="resultat in currentResults"
              :key="resultat.id"
              :resultat="resultat"
              :level="activeTab"
