            ...
            <div>
              ...
              <div class="space-y-3">
                <div class="flex items-start gap-3">
                  ...
                  />
                  <div>
                    <label for="edit_can_create_projects" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <div class="flex items-start gap-3">
                  <input
                    ...
                    type="checkbox"
                    id="edit_can_invite_members"
                    class="mt-1 w-4 h-4 text-brand-600 bg-gray-100 border-gray-300 rounded focus:ring-brand-500 dark:focus:ring-brand-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <div>
                    <label for="edit_can_invite_members" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <div class="flex items-start gap-3">
                  <input
                    ...
                    type="checkbox"
                    id="edit_can_manage_settings"
                    class="mt-1 w-4 h-4 text-brand-600 bg-gray-100 border-gray-300 rounded focus:ring-brand-500 dark:focus:ring-brand-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <div>
                    <label for="edit_can_manage_settings" class="text-sm font-medium text-gray-700 dark:text-gray-300">
              ...
              <div class="flex gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-blue-800 dark:text-blue-400 mt-1">
                    Les permissions spécifiques aux projets doivent être gérées individuellement dans chaque projet.
                  </p>
                </div>
              </div>
            </div>
...
const { updateMember } = useWorkspace()
...
const handleSubmit = async () => {
  try {
    ...
    await updateMember(props.workspaceId, props.member.id, {
...
onMounted(() => {
  form.value = {
    role: props.member.pivot?.role || 'member',
    can_create_projects: props.member.pivot?.can_create_projects || false,
    can_invite_members: props.member.pivot?.can_invite_members || false,
    can_manage_settings: props.member.pivot?.can_manage_settings || false
  }
})
</script>