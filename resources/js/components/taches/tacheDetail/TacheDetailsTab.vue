...
<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="bg-gray-50 dark:bg-gray-800 rounded-3 p-6">
          ...
          <div>
            ...
            <div v-if="editing.field === 'statut'">
              <select
                ...
                autofocus
                class="w-full px-3 py-1.5 text-sm border border-brand-500 rounded-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500"
              >
        ...
        <div>
          ...
          <div v-if="editing.field === 'description'">
            <textarea
              ...
              autofocus
              rows="4"
              class="w-full px-3 py-2 text-sm border border-brand-500 rounded-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none"
            ></textarea>
          </div>
          <p
            v-else
            @click="startEdit('description', localTache.description)"
            class="text-gray-700 dark:text-gray-300 whitespace-pre-wrap min-h-8 rounded-3 p-2 -m-2"
    ...
    <div v-if="localTache.estimated_hours || localTache.actual_hours" class="bg-gray-50 dark:bg-gray-800 rounded-3 p-6">
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
    ...
    <!-- Labels -->
    <div v-if="localTache.labels && localTache.labels.length > 0" class="bg-gray-50 dark:bg-gray-800 rounded-3 p-6">
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
    ...
    <!-- Validation -->
    <div v-if="localTache.validation" class="bg-gray-50 dark:bg-gray-800 rounded-3 p-6">
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
      ...
      <div class="space-y-4">
        ...
        <!-- Statut global -->
        <div v-if="localTache.validation.is_fully_validated" class="bg-green-50 dark:bg-green-900/20 rounded-3 p-3">
