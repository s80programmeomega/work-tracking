  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 "
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3 w-full max-w-lg">
      ...
      <form @submit.prevent="handleReject" class="p-6 space-y-5">
        ...
        <!-- Info résultat -->
        <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-3 border border-gray-200 dark:border-gray-700">
        ...
        <div>
          ...
          <textarea
            ...
            class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-3 focus:ring-2 focus:ring-red-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-all"
          ></textarea>
        ...
        <!-- Warning -->
        <div class="p-4 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 rounded-3">
      ...
      <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex justify-end gap-3">
        <button
          ...
          @click="$emit('close')"
          :disabled="rejecting"
          class="px-5 py-2.5 border-2 border-gray-300 dark:border-gray-600 rounded-3 hover:bg-gray-100 dark:hover:bg-gray-700 font-medium text-gray-700 dark:text-gray-300 transition-all disabled:opacity-50"
        >
          Annuler
        </button>
        ...
        <button
          ...
          class="px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-3 font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
        >
