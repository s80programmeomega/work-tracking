...
<template>
  <div class="flex flex-col gap-2">
    ...
    <div 
      ...
      class="mt-1 inline-flex items-center gap-1 px-2 py-1 text-xs font-bold text-green-800 bg-gradient-to-r from-green-100 to-green-200 dark:from-green-900/40 dark:to-green-800/40 dark:text-green-300 rounded-full border border-green-300 dark:border-green-700">
