  ...
  <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
    ...
    <td class="px-6 py-4">
      ...
      <button
        ...
        class="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 font-medium flex items-center gap-1 px-3 py-2 border border-blue-300 dark:border-blue-700 rounded-3 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <td class="px-6 py-4">
      <div class="flex items-center justify-center gap-2">
        ...
        <button
          ...
          :title="$t('fiches_eval.row_edit_result')">
        ...
        <button
          ...
          :title="$t('fiches_eval.row_view_result')">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
          </svg>
        ...
        <button
          @click="$emit('refresh')"
          class="p-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-3 transition-colors"
          :title="$t('fiches_eval.row_refresh')">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
