<template>
  <div
    class="rounded-3 border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6"
  >
    <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
      ...
      <div class="relative">
        <div class="inline-flex items-center gap-0.5 rounded-3 bg-gray-100 p-0.5 dark:bg-gray-900">
          <button
