<template>
  <div class="relative" ref="multiSelectRef">
    <div
      ...
      class="dark:bg-dark-900 h-11 flex items-center w-full appearance-none rounded-3 border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
    ...
    >
      <div
        v-if="isOpen"
        class="absolute z-10 w-full mt-1 bg-white rounded-3 dark:bg-gray-900"
      >
        <ul
