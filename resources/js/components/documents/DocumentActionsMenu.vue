<!-- resources\js\components\documents\DocumentActionsMenu.vue -->
<template>
  <div class="space-y-6">
    <!-- Header -->
    ...
    <div v-else-if="permissions.length === 0" class="rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-8 text-center dark:border-gray-700 dark:bg-gray-900/50">
    ...
    <div v-else class="space-y-3">
      <div
        ...
        :key="permission.id"
        class="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]"
      >
        <!-- User Info -->
