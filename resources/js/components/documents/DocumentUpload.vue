...
<template>
  <div class="space-y-4">
    ...
    <div
      ...
      :class="[
        'relative rounded-3 border-2 border-dashed p-8 text-center transition-all',
        dragOver
    ...
    >
      <div
        ...
        :key="file.id"
        class="flex items-center gap-4 rounded-3 border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]"
      >
        <!-- File Icon -->
    ...
    <!-- Upload Options -->
    <div v-if="selectedFiles.length > 0" class="space-y-4 rounded-3 border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
      <!-- Description -->
      <div>
