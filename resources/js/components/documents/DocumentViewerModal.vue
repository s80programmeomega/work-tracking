    ...
    <Dialog as="div" class="relative z-50" @close="$emit('close')">
      <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            <DialogPanel ref="dialogRef" :style="dragStyle" class="relative w-full max-w-6xl transform overflow-hidden rounded-3 border border-gray-200 dark:border-gray-700 bg-white transition-all dark:bg-gray-900">
              <!-- Header -->
