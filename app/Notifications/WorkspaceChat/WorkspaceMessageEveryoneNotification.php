...
class WorkspaceMessageEveryoneNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("[{$workspaceName}] {$this->actor->nom} a mentionné @everyone dans #{$channelLabel}")
            ->greeting("Bonjour {$notifiable->prenom},")
            ->line("{$this->actor->nom} a envoyé un message à tous les membres du workspace **{$workspaceName}** dans le canal **#{$channelLabel}**.")
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'type' => 'workspace_chat_everyone',
            'title' => "{$this->actor->nom} a mentionné @everyone",
