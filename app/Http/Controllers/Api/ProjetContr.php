...
class ProjetController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => ProjetResource::collection($projets->items()),
            'meta' => [
    ...
    public function store(StoreProjetRequest $request): JsonResponse
    {
        ...
        if (!$workspace || !$workspace->hasAccess($request->user())) {
            return response()->json([
        ...
        try {
            ...
            Log::error('Error creating projet: ' . $e->getMessage());
            return response()->json([
  ...
  /**
    ...
    public function update(UpdateProjetRequest $request, Projet $projet): JsonResponse
    {
        ...
        try {
            ...
            Log::error('Error updating projet: ' . $e->getMessage());
            return response()->json([
   ...
   /**
    ...
    public function destroy(Projet $projet): JsonResponse
    {
        ...
        try {
            ...
            Log::error('Error deleting projet: ' . $e->getMessage());
            return response()->json([
